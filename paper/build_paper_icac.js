// ICAC 2026 paper (official IEEE A4 conference template geometry), IEEE two-column. Run: node paper/build_paper.js
const fs = require("fs");
const {
...
col.push(body("Practically, deployments should measure their inter-tier energy ratio before adopting a cascade, monitor escalation against the break-even condition as traffic shifts, and verify that the small tier clears a capability threshold on their own workload. Our implementation exposes all three quantities at runtime."));
...
const doc = new Document({
  ...
  sections: [
    { properties: { page: { size: { width: 11906, height: 16838 },
        margin: { top: 1080, bottom: 1440, left: 907, right: 907 } } }, children: head },
    { properties: { type: SectionType.CONTINUOUS,
        column: { count: 2, space: 360, equalWidth: true },
        page: { size: { width: 11906, height: 16838 },
          margin: { top: 1080, bottom: 1440, left: 907, right: 907 } } }, children: col },
  ],
});
Packer.toBuffer(doc).then(b => {
  fs.writeFileSync("paper/ICAC2026_GreenGate.docx", b);
  console.log("wrote paper/ICAC2026_GreenGate.docx");
});
